...
const ValueCard = ({ icon: Icon, title, description, colorClass, bgClass }) => (
  <div className="bg-white p-6 rounded-2xl hover:shadow-lg transition-all border border-gray-100 group">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center mb-16 md:mb-24">
          <div className="order-2 lg:order-1">
            ...
            <div className="flex gap-4">
              <a href="mailto:support@marvelpdf.com" className="bg-marvel-black text-white px-6 py-3 rounded-xl font-bold hover:bg-gray-900 transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 inline-flex items-center gap-2 text-sm md:text-base">
        ...
        <div className="mb-16 md:mb-20">
          <div className="text-center mb-10 md:mb-12">
            <h2 className="text-2xl md:text-3xl font-heading text-marvel-black mb-3">Our Core Values</h2>
