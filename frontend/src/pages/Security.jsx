...
const SecurityFeature = ({ icon: Icon, title, description, color = "text-marvel-red", bg = "bg-marvel-red/10" }) => (
  <div className="bg-white/5 p-6 rounded-2xl hover:bg-white/10 transition-all border border-white/10 group backdrop-blur-sm">
    ...
    <h3 className="font-heading text-xl mb-3 text-white">{title}</h3>
...
const Security = () => {
  ...
  return (
    <div className="min-h-screen pt-24 pb-12 px-4 sm:px-6 lg:px-8 absolute inset-0 z-40 overflow-y-auto">
      <SEO 
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-12">
            <Link to="/" className="inline-flex items-center gap-2 text-gray-400 hover:text-white transition-colors font-medium">
                <div className="p-2 bg-white/5 rounded-lg border border-white/10 hover:bg-white/10 transition-all">
                    <ArrowLeft size={20} />
                </div> Back to Tools
            </Link>
        </div>
        ...
        <div className="text-center mb-20">
             <h1 className="text-5xl md:text-6xl font-heading text-white mb-6 tracking-tight">Security is our DNA</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-20">
            <div>
                <h2 className="text-4xl font-heading text-white mb-6">End-to-End Protection</h2>
                <div className="space-y-6">
                    <div className="flex gap-4">
                        <FileKey className="text-gray-500 shrink-0 mt-1" size={24} />
                        <div>
                            <h4 className="font-bold text-lg mb-1 text-gray-200">Data at Rest</h4>
                            <p className="text-gray-400 text-sm">Even during their short 2-hour lifespan, your files are stored on encrypted disks (AES-256). Metadata records in our database are also encrypted.</p>
                        </div>
                    </div>
                    <div className="flex gap-4">
                        <Globe className="text-gray-500 shrink-0 mt-1" size={24} />
                        <div>
                            <h4 className="font-bold text-lg mb-1 text-gray-200">Global Compliance</h4>
                            <p className="text-gray-400 text-sm">We are fully compliant with GDPR (Europe) and CCPA (California) regulations. You have full control over your data identity.</p>
                        </div>
                    </div>
                    <div className="flex gap-4">
                        <RefreshCcw className="text-gray-500 shrink-0 mt-1" size={24} />
                        <div>
                            <h4 className="font-bold text-lg mb-1 text-gray-200">Continuous Monitoring</h4>
                            <p className="text-gray-400 text-sm">We use automated vulnerability scanning and intrusion detection systems to monitor our infrastructure 24/7/365.</p>
                        </div>
                    </div>
                </div>
            </div>
            
            <div className="bg-[#111] border border-white/10 rounded-3xl p-8 md:p-12 text-white relative overflow-hidden shadow-2xl">
                ...
                <a href="mailto:support@marvelpdf.com" className="inline-flex items-center justify-center gap-2 bg-white text-black font-bold py-3 px-6 rounded-xl hover:bg-gray-200 transition-colors relative z-10">
        ...
        <div className="border-t border-white/10 pt-12 text-center">
            <p className="text-gray-500 text-sm">
                Questions about our security practices? Email us at <a href="mailto:support@marvelpdf.com" className="text-marvel-red hover:text-white transition-colors hover:underline">support@marvelpdf.com</a>
            </p>
        </div>
