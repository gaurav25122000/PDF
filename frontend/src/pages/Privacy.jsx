      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10">
        ...
        <div className="lg:col-span-9">
          <div className="bg-white/80 backdrop-blur-sm p-8 md:p-12 rounded-3xl shadow-sm border border-gray-100">
            <h1 className="text-4xl md:text-6xl font-heading text-marvel-black mb-6">Privacy Policy</h1>
            ...
            <div className="prose prose-lg max-w-none prose-headings:font-heading prose-headings:text-marvel-black prose-a:text-marvel-red text-gray-600 prose-ul:list-disc prose-ul:pl-0 prose-li:my-2">
              ...
              <section id="collect" className="scroll-mt-32 mb-16">
              ...
              <section id="handling" className="scroll-mt-32 mb-16">
                <h2>2. How We Handle Your Files (Critical)</h2>
                <div className="bg-red-50/50 border border-red-100 rounded-2xl p-6 not-prose mb-6 backdrop-blur-sm">
